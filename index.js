...
let [bessie, dolly, babe, little] = [...animalArray].filter(animal => animal!="horse");

// 3. Little the chicken had to go back to the coop, so now we're left with three. Let's use color variables of blackAndWhite, black, and pink.
let [blackAndWhite, black, pink]=[...animalArray].filter(animal => animal !=="chicken").filter(animal => animal !=="horse");
...
let [r, o, y, g, b, v] = [...colors].filter(color => color !=="indigo");

// 6. But wait! Indigo is now feeling *super* left out. Let's only assign indigo using indg. 
let [indg] = [...colors].filter(color => color === "indigo");
